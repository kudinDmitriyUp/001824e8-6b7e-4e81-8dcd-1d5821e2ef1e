...
export const metadata: Metadata = {
  title: "TechShop Milano | Venture Capital Investor",
  description: "TechShop Milano invests in early-stage tech founders building AI, fintech, and deep tech companies. €200M+ portfolio across Europe.",
  keywords: "venture capital, tech investment, seed funding, startup funding, Milan, Europe",
  metadataBase: new URL("https://techshopmilano.com"),
  alternates: {
    canonical: "https://techshopmilano.com"
  },
  openGraph: {
    title: "TechShop Milano | Backing Bold Founders",
    description: "Venture capital firm investing in the next generation of European technology leaders",
    url: "https://techshopmilano.com",
    siteName: "TechShop Milano",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764145370782-ox4jocl4.jpg",
      alt: "TechShop Milano venture capital"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "TechShop Milano | VC for European Tech",
    description: "Investing in founders building transformative technology",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764145370782-ox4jocl4.jpg"]
  },
  robots: {
    index: true,
    follow: true
